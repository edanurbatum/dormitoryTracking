    ...
    public void populateTable(String sql,JTable tbl){
        ...
        try {
            ...
            for (Permit permit:permits) {
                Object[]row={
                    permit.getTc(),permit.getName(),permit.getLastName(),permit.getRemainingPermitAmount(),
                    permit.getPermitStart(),permit.getPermitFinish(),permit.getPermitAddress(),permit.getUsedPermitAmount()
                }; 
                model.addRow(row);
            }     
        ...
        try{
            ...
            while(resultSet.next()){
                permits.add(new Permit(
                        resultSet.getString("permitRecordNo"),
