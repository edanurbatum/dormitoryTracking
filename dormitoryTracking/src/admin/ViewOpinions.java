...
public class ViewOpinions extends javax.swing.JFrame {
    ...
    public ViewOpinions() {
        ...
        try {
            ...
            Logger.getLogger(ViewOpinions.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        tblOpinions.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Tc", "İsim", "Soyisim", "Oda Numarası", "Yatak Numarası", "İçerik"
            }
        ) {
        ...
        if (tblOpinions.getColumnModel().getColumnCount() > 0) {
            ...
            tblOpinions.getColumnModel().getColumn(5).setResizable(false);
        }
    ...
    private void tblOpinionsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblOpinionsMouseClicked
        txtShow.setText(tblOpinions.getValueAt(tblOpinions.getSelectedRow(), 6).toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewOpinions.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
